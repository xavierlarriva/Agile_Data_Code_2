...
# Install Spark
#
echo "curl -sLko /tmp/spark-2.2.1-bin-without-hadoop.tgz http://mirror.nbtelecom.com.br/apache/spark/spark-2.2.1/spark-2.2.1-bin-without-hadoop.tgz"
curl -sLko /tmp/spark-2.2.1-bin-without-hadoop.tgz http://mirror.nbtelecom.com.br/apache/spark/spark-2.2.1/spark-2.2.1-bin-without-hadoop.tgz
...
# Give Spark 4GB of RAM, used Python3
...
cd /home/vagrant/Agile_Data_Code_2
echo "curl -sLko lib/snappy-java-1.1.7.1.jar http://central.maven.org/maven2/org/xerial/snappy/snappy-java/1.1.7.1/snappy-java-1.1.7.1.jar"
...
echo "curl -sLko lib/lzo-hadoop-1.0.5.jar http://central.maven.org/maven2/org/anarres/lzo/lzo-hadoop/1.0.5/lzo-hadoop-1.0.5.jar"
...
cd /home/vagrant/
tar -xvzf /tmp/kafka_2.11-1.0.0.tgz -C kafka --strip-components=1 && rm -f /tmp/kafka_2.11-0.10.1.1.tgz
